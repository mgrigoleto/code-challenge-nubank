...
Para compilar e executar o projeto, é necessário instalar o `.NET v8.0` ou superior. As instruções para instalação seguem nos links abaixo:
...
1. Extraia o arquivo `csharp.zip`.
2. Entre na pasta descompactada (`/csharp`).
